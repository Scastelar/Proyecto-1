...
public class crearPlayer extends javax.swing.JFrame {
    ...
    public crearPlayer() {
        ...
        cuentas = new cuentasStratego(100);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 0, 470, 420));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       if ((jTextField1.getText()).isEmpty()==true){
        ...
        if (cuentas.agregarCuenta(cuenta, password)){
            JOptionPane.showMessageDialog(null, "Player creado!");
        } 
